...
|소속|직책|기간|비고|
|:---:|:---:|:---:|:---:|
|INCOM|`동아리 부원` `학술 부장`|2024.03 ~ 2026.01|25년도 운영진|
|인공지능 생명정보 연구실|`병리 이미지 팀`|2025.03 ~ |이상선 교수님|
|인공지능공학과 학생회|`24-2 홍보부` `25-1 학술부` `26-1 총무부`|2024.09 ~ 2025.05 / 2026.01 ~ ||
|소프트웨어융합대학 학생회|`대외협력국장`|2025.05 ~ 2025.12||
|인공지능학회 SINSA|`학술부`||2026.03 ~ ||
...
|MS NET-ZERO 해커톤|인사|`BE` `DB Manage`|2025.06.26 ~ 27|-|
|위암 병리이미지 분류 모델 제작|병리이미지팀|`MoE 설계` `패치 분류 모델 훈련`|2025.06 ~ |서울대병원 및 성모병원 협력|
|KSBI BIOINFO 2025|병리이미지팀|`Classification MoE Model` `포스터 발표`|2025.09.13 ~ 2025.10.16|First Author|
